...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<Emp> Task1()
        {
            ...
            result = Emps.Where(s => s.Job == "Backend programmer");
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = null;
            result = Emps.Where(s => s.Job == "Frontend programmer" && s.Salary > 1000)
        ...
        {
            IEnumerable<Emp> result = null;
            result = Emps.Where(s => s.Salary == Emps.Max(e => e.Salary));
            return result;
        }
        ...
        public static IEnumerable<object> Task5()
        {
            ...
            result = Emps.Select(s => new { Nazwisko = s.Ename, Praca = s.Job });
            return result;
        }
        ...
        public static IEnumerable<object> Task7()
        {
            IEnumerable<object> result = Emps.GroupBy(e => e.Job)
                .Select(gr => new { Praca = gr.Key, LiczbaPracownikow = gr.Count() });
            return result;
        }
        ...
        {
            IEnumerable<object> result = null;
            //Emps.Select(e => new { e.Ename, e.Job, e.HireDate }).Union(Emps.Select())
            return result;
        }
        ...
        {
            IEnumerable<object> result = Emps.GroupBy(e => e.Deptno).Where(gr => gr.Count() > 1)
                .Select(gr => new { name = gr.Key, NumOfEmployees = gr.Count() }).OrderBy(d => d.name).ToList();
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = CustomExtensionMethods.WithMinOneSub(Emps);
            return result;
        }
        ...
        {
            int result = arr.GroupBy(n => n).Where(gr => gr.Count() % 2 != 0).Select(gr => gr.Key).Single();
            //result=
            return result;
        }
    ...
    {
        public static IEnumerable<Emp> WithMinOneSub(this IEnumerable<Emp> Emps)
        {
